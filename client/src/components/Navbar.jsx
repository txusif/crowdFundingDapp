                        ...
                        {navlinks.map((link) => (
                            ...
                            >
                                <img
                                    src={link.imgUrl}
                                    alt={link.name}
                                    className={`w-[24px] h-[24px] object-contain text-[14px] ${isActive === link.name ? "grayscale-0" : "grayscale"}`}
                                />
                                <p className={`font-epilogue font-semibold ml-[20px] text-[14px] ${isActive === link.name ? "text-[#1dc071]" : "text-[#808191]"}`}>
                                    {link.name}
                                </p>
